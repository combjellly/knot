...
data EngineRecord = EngineRecord {
  pRef :: Ref Program
} 
...
-- render :: {- DateTime -> DateTime -> Tempo -> *} EngineRecord -> Effect Unit
 -- render _ _ _ re = do what crudeScheduler JUST EngineRecord. everything (wStart wEnd is stored in our EngineRecord)
