...
(function($PS) {
  ...
  var Data_List_Types = $PS["Data.List.Types"];
  var Data_Show = $PS["Data.Show"];                
  var SampleEvent = (function () {
      function SampleEvent(value0) {
          this.value0 = value0;
      };
      SampleEvent.create = function (value0) {
          return new SampleEvent(value0);
      };
      return SampleEvent;
  })();
  var showEvent = {
      show: function (v) {
          return v.value0.sampleBank + (" " + Data_Show.show(Data_Show.showNumber)(v.value0.when));
      }
  };
  var sampleNaming = function (s) {
      return function (w) {
  ...
  var samplePlayEvents = function (wStart) {
      return function (wEnd) {
          return function (n) {
              return function (s) {
                  var xs = cycleIntervalList(wStart)(wEnd)(n);
                  return Data_Functor.map(Data_List_Types.functorList)(sampleNaming(s))(xs);
              };
          };
      };
  };
  var renderAction = function (wStart) {
      return function (wEnd) {
          return function (n) {
              return function (v) {
                  if (v instanceof AST.VariableAction) {
                      return Data_List_Types.Nil.value;
                  };
                  if (v instanceof AST.Play) {
                      return samplePlayEvents(wStart)(wEnd)(n)(v.value0);
                  };
                  throw new Error("Failed pattern match at RenderEngine (line 37, column 1 - line 37, column 73): " + [ wStart.constructor.name, wEnd.constructor.name, n.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
  var renderLoop = function (wStart) {
      return function (wEnd) {
          return function (v) {
              return Data_List.concat(Data_Functor.map(Data_List_Types.functorList)(renderAction(wStart)(wEnd)(v.value0))(v.value1));
          };
      };
  };
  var renderElement = function (wStart) {
      return function (wEnd) {
          return function (v) {
              if (v instanceof AST.VariableGlobal) {
                  return Data_List_Types.Nil.value;
              };
              if (v instanceof AST.LoopElement) {
                  return renderLoop(wStart)(wEnd)(v.value0);
              };
              throw new Error("Failed pattern match at RenderEngine (line 30, column 1 - line 30, column 65): " + [ wStart.constructor.name, wEnd.constructor.name, v.constructor.name ]);
          };
      };
  };
  var renderEvents = function (p) {
      return function (wStart) {
          return function (wEnd) {
              return Data_List.concat(Data_Functor.map(Data_List_Types.functorList)(renderElement(wStart)(wEnd))(p));
          };
      };
  };
...
(function($PS) {
  ...
  var parse = function (pRef) {
      return function (x) {
          ...
          if (v instanceof Data_Either.Right) {
              return function __do() {
                  Effect_Ref.write(v.value0)(pRef)();
                  return Data_Show.show(Data_Show.showString)("success");
              };
          };
          throw new Error("Failed pattern match at Main (line 58, column 16 - line 62, column 28): " + [ v.constructor.name ]);
      };
  };
  var main = Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
  var crudeScheduler = function (wStart) {
      return function (pRef) {
          var wEnd = wStart + 0.252;
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(Data_Show.show(Data_Show.showNumber)(wStart) + (" " + Data_Show.show(Data_Show.showNumber)(wEnd)))))(function () {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(pRef)))(function (p) {
                  var es = RenderEngine.renderEvents(p)(wStart)(wEnd);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(printToConsole(es)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(252.0))(function () {
                          return crudeScheduler(wEnd)(pRef);
                      });
                  });
              });
          });
  ...
  var launch = function __do() {
      var pRef = Effect_Ref["new"](new Data_List_Types.Cons(new AST.LoopElement(new AST.Loop(2.0, new Data_List_Types.Cons(new AST.Play("cat"), Data_List_Types.Nil.value))), Data_List_Types.Nil.value))();
      Effect_Aff.launchAff(crudeScheduler(3.0e-2)(pRef))();
      return pRef;
  };
  exports["main"] = main;
  exports["launch"] = launch;
  exports["crudeScheduler"] = crudeScheduler;
