...
(function($PS) {
  ...
  var showVariable = {
      show: function (v) {
          return Data_Show.show(Data_Show.showString)(v.value0) + ("=" + Data_Show.show(Data_Show.showNumber)(v.value1));
      }
  };
  var showPlay = {
      show: function (v) {
          if (v instanceof Play) {
              return "play.(" + (Data_Show.show(Data_Show.showString)(v.value0) + ")");
          };
          if (v instanceof VariableAction) {
              return "(" + (Data_Show.show(showVariable)(v.value0) + ")");
          };
          throw new Error("Failed pattern match at AST (line 29, column 1 - line 31, column 49): " + [ v.constructor.name ]);
      }
  };
  var showLoop = {
      show: function (v) {
          return "(Every " + (Data_Show.show(Data_Show.showNumber)(v.value0) + (" " + (Data_Show.show(Data_List_Types.showList(showPlay))(v.value1) + ")")));
      }
  };
  var showElement = {
      show: function (v) {
          if (v instanceof LoopElement) {
              return "[" + (Data_Show.show(showLoop)(v.value0) + "]");
          };
          if (v instanceof VariableGlobal) {
              return "[" + (Data_Show.show(showVariable)(v.value0) + "]");
          };
          throw new Error("Failed pattern match at AST (line 21, column 1 - line 23, column 49): " + [ v.constructor.name ]);
      }
  };
  ...
  var parse = function (e) {
      return function (x) {
          return Control_Applicative.pure(Effect.applicativeEffect)((function () {
              ...
              if (v instanceof Data_Either.Right) {
                  return Data_Show.show(Data_List_Types.showList(AST.showElement))(v.value0);
              };
              throw new Error("Failed pattern match at Main (line 24, column 20 - line 26, column 22): " + [ v.constructor.name ]);
          })());
      };
  };
  var main = Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
  var launch = Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
  exports["main"] = main;
